...
const EXAMPLES_MAP: Record<string, ExampleMetadata> = {
  ...
  "fhe-equal": {
    contract: "contracts/basic/FHEEqual.sol",
    test: "test/basic/FHEEqual.test.ts",
    title: "FHE Equality Comparison",
    description: "Demonstrates encrypted equality operations using FHE.eq()",
    difficulty: "beginner",
    category: "basic",
  },
  ...
  "encrypt-multiple-values": {
    ...
    test: "test/encrypt/EncryptMultipleValues.test.ts",
    title: "Encrypt Multiple Values",
    description: "Demonstrates batch encryption of multiple values",
    difficulty: "beginner",
    category: "encryption",
  },
  "user-decrypt-single": {
  ...
  "user-decrypt-multiple": {
    ...
    test: "test/decrypt/UserDecryptMultipleValues.test.ts",
    title: "User Decrypt Multiple Values",
    description: "Demonstrates decryption of multiple encrypted values",
    difficulty: "intermediate",
    category: "decryption",
  },
  "public-decrypt-single": {
    contract: "contracts/decrypt/PublicDecryptSingleValue.sol",
    test: "test/decrypt/PublicDecryptSingleValue.test.ts",
    title: "Public Decrypt Single Value",
    description: "Demonstrates public decryption via relayer",
    difficulty: "intermediate",
    category: "decryption",
  },
  "public-decrypt-multiple": {
    contract: "contracts/decrypt/PublicDecryptMultipleValues.sol",
    test: "test/decrypt/PublicDecryptMultipleValues.test.ts",
    title: "Public Decrypt Multiple Values",
    description: "Demonstrates batch public decryption patterns",
    difficulty: "intermediate",
    category: "decryption",
  },
  "access-control": {
